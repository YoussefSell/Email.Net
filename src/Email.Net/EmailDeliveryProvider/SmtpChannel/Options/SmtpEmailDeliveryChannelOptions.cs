namespace Email.Net.Channel.Smtp
{
    ...
    /// </summary>
    public class SmtpEmailDeliveryChannelOptions
    {
        /// <summary>
        ...
        public void Validate()
        {
            if (SmtpOptions is null)
                throw new RequiredOptionValueNotSpecifiedException<EmailServiceOptions>(
                    nameof(SmtpOptions), "the given SmtpEmailDeliveryChannelOptions.SmtpOptions are null, you must supply a valid smtpOptions.");
