namespace Email.Net.Channel.AmazonSES
{
    ...
    /// <summary>
    /// the AmazonSES client email delivery channel
    /// </summary>
    public partial class AmazonSESEmailDeliveryChannel : IAmazonSESEmailDeliveryChannel
    {
        /// <inheritdoc/>
        ...
        public async Task<EmailSendingResult> SendAsync(EmailMessage message, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                var response = await client.SendEmailAsync(CreateMessage(message), cancellationToken)
    ...
    /// <summary>
    /// partial part for <see cref="AmazonSESEmailDeliveryChannel"/>
    /// </summary>
    public partial class AmazonSESEmailDeliveryChannel
    {
        /// <summary>
        /// the name of the email delivery channel
        /// </summary>
        public const string Name = "amazon_ses_channel";

        /// <inheritdoc/>
        string IEmailDeliveryChannel.Name => Name;

        private readonly AmazonSESEmailDeliveryChannelOptions _options;

        /// <summary>
        /// create an instance of <see cref="AmazonSESEmailDeliveryChannel"/>
        /// </summary>
        /// <param name="options">the options instance</param>
        /// <exception cref="ArgumentNullException">the given options instance is null</exception>
        public AmazonSESEmailDeliveryChannel(AmazonSESEmailDeliveryChannelOptions options)
        {
            if (options is null)
