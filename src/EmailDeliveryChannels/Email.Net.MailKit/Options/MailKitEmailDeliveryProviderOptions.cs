namespace Email.Net.Channel.MailKit
{
    ...
    /// <summary>
    /// the options for configuring the MailKit email delivery channel
    /// </summary>
    public class MailKitEmailDeliveryChannelOptions
    {
        /// <summary>
        ...
        public void Validate()
        {
            if (SmtpOptions is null)
                throw new RequiredOptionValueNotSpecifiedException<EmailServiceOptions>(
                    nameof(SmtpOptions), "the given MailKitEmailDeliveryChannelOptions.SmtpOptions are null, you must supply a valid smtpOptions.");
        ...
        /// </summary>
        /// <param name="email">your Gmail email.</param>
        /// <param name="password">your Gmail password.</param>
        /// <remarks>
